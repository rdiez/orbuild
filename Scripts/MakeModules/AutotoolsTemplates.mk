...
define autotool_project_template_variables_1
  ...
  $(1)_CONFIGURE_SENTINEL   := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Configure.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
  $(1)_MAKE_SENTINEL        := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Make.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
  $(1)_INSTALL_SENTINEL     := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Install.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
  $(1)_CHECK_SENTINEL       := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Check.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
  $(1)_DISTCHECK_SENTINEL   := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Distcheck.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
...
define autogen_template_variables
  ...
  $(1)_AUTOGEN_SENTINEL         := $(ORBUILD_AUTOCONF_SENTINELS_DIR)/$(1).Autogen.$(ORBUILD_SENTINEL_FILENAME_SUFFIX)
