...
You need to use Peter Gavin's toolchain to generate code for OR10. The I<< orbuild >> framework
can automatically download and build all the components you need.
...
the "traditional" L<< OR1200|http://opencores.org/or1k/Main_Page >> CPU
and the new L<< AltOr32|http://opencores.org/project,altor32 >> implementation.
