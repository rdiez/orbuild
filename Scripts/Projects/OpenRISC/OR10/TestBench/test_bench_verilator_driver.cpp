...
{
  // Signal SIGPIPE can happen if one of the DPI modules write data to a socket and the remote side has already
...
{
  const uint8_t RESET_ASSERTED   = 1;
  const uint8_t RESET_DEASSERTED = 0;
