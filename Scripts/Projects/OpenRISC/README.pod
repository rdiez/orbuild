...
Under Ubuntu/Debian systems, the following command installs all prerequisites at once:
  ...
  sudo apt-get install gcc g++ libmpfr-dev libgmp3-dev libmpc-dev libzip-dev libtool texlive flex bison texinfo libncurses-dev gperf dejagnu verilator iverilog
