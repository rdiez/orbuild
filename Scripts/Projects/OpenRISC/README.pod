...
If your system does not have a package with Verilator or Icarus Verilog, you can enable building them in the Makefile.
...
you'll have to enable building them in the Makefile.
